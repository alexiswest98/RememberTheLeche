...
def seed_groups():
    ...
    group2 = Group(
        name='Gym Sesh', owner_id=2)
    group3 = Group(
        name='Tree planting', owner_id=4)
    group4 = Group(
        name='Cooking class', owner_id=12)
    group5 = Group(
        name='Clean the house', owner_id=7)
    group6 = Group(
        name='Coding Group Project', owner_id=14)
    group6 = Group(
